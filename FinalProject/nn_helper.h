...
typedef struct { int num_floats; float* pArray; } layerParamArray;

int save_network_parameters_to_binaryfile(string strSaveFileFullPath, int& num_arrays, layerParamArray* pParamArrays)
{
...
int load_network_parameters_from_binaryfile(string strNNParamFileFullPath, int& num_arrays, layerParamArray* pParamArrays)
{
